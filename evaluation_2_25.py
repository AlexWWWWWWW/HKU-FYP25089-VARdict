...
def main():
    ...
    PHASE1_PATH = "./checkpoints_2_25/phase1/final"
    LORA_PATH = "./checkpoints_2_25/phase2/final_lora" # 你的 LoRA 训练成果
    
    DATA_ROOT = "./full_dataset_2_25"
    ...
    OUTPUT_DIR = "./vardict_generated_results_2_25.json"
    
    # ================= 2. 加载模型与权重 =================
    print(">>> Loading base model...")
    model, tokenizer = safe_load_model(PHASE1_PATH, pose_feature_dim=2*26*2, device='cuda')
